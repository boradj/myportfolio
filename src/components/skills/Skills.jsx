...
import { FaReact, FaSignLanguage } from "react-icons/fa";
          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                <ProgressBar logo={<SiPytorch />} name={"Pytorch / Tensorflow"} value={95} />
                <ProgressBar logo={<SiGooglehangouts/>} name={"Natural language processing"} value={88} />
                <ProgressBar
                  logo={<SiGit />}
                  name={"Git / Github"}
                  value={80}
                />
                <ProgressBar logo={<SiLinux />} name={"Linux"} value={80} />
                <ProgressBar
                  logo={<SiTailwindcss />}
                  name={"Tailwind CSS"}
                  value={80}
